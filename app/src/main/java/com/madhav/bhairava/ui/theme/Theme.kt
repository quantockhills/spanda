...
val DevanagariFont = FontFamily(
    Font(R.font.tiro_devanagari_regular),
    Font(R.font.tiro_devanagari_italic, style = FontStyle.Italic)
)

val SerifFont = FontFamily(
    Font(R.font.gentiumplus_regular),
    Font(R.font.gentiumplus_bold, weight = FontWeight.Bold),
    Font(R.font.gentiumplus_italic, style = FontStyle.Italic)
)
